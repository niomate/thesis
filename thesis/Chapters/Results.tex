...
The hypothesis was tested by switching out the Gaussian
...
\begin{figure}[H]
    ...
    \begin{tabular}{|c|cccccc|}
        ...
        \raisebox{0.8cm}{1} &
        \addheight{\includegraphics[width=0.12\linewidth]{../Images/inacctest/cornerr1m1mask.png}}
          &
        \addheight{\includegraphics[width=0.12\linewidth]{../Images/inacctest/cornerr1m2mask.png}}
          &
        \addheight{\includegraphics[width=0.12\linewidth]{../Images/inacctest/cornerr1m3mask.png}}
          &
        \addheight{\includegraphics[width=0.12\linewidth]{../Images/inacctest/cornerr1m4mask.png}}
          &
        \addheight{\includegraphics[width=0.12\linewidth]{../Images/inacctest/cornerr1m5mask.png}}
          &
        \addheight{\includegraphics[width=0.12\linewidth]{../Images/inacctest/cornerr1m6mask.png}}\\
        \raisebox{0.8cm}{2} &
        \addheight{\includegraphics[width=0.12\linewidth]{../Images/inacctest/cornerr2m1mask.png}}
          &
        \addheight{\includegraphics[width=0.12\linewidth]{../Images/inacctest/cornerr2m2mask.png}}
          &
        \addheight{\includegraphics[width=0.12\linewidth]{../Images/inacctest/cornerr2m3mask.png}}
          &
        \addheight{\includegraphics[width=0.12\linewidth]{../Images/inacctest/cornerr2m4mask.png}}
          &
        \addheight{\includegraphics[width=0.12\linewidth]{../Images/inacctest/cornerr2m5mask.png}}
          &
        \addheight{\includegraphics[width=0.12\linewidth]{../Images/inacctest/cornerr2m6mask.png}}\\
        \raisebox{0.8cm}{3} &
        \addheight{\includegraphics[width=0.12\linewidth]{../Images/inacctest/cornerr3m1mask.png}}
          &
        \addheight{\includegraphics[width=0.12\linewidth]{../Images/inacctest/cornerr3m2mask.png}}
          &
        \addheight{\includegraphics[width=0.12\linewidth]{../Images/inacctest/cornerr3m3mask.png}}
          &
        \addheight{\includegraphics[width=0.12\linewidth]{../Images/inacctest/cornerr3m4mask.png}}
          &
        \addheight{\includegraphics[width=0.12\linewidth]{../Images/inacctest/cornerr3m5mask.png}}
          &
        \addheight{\includegraphics[width=0.12\linewidth]{../Images/inacctest/cornerr3m6mask.png}}\\
        \raisebox{0.8cm}{4} &
        \addheight{\includegraphics[width=0.12\linewidth]{../Images/inacctest/cornerr4m1mask.png}}
          &
        \addheight{\includegraphics[width=0.12\linewidth]{../Images/inacctest/cornerr4m2mask.png}}
          &
        \addheight{\includegraphics[width=0.12\linewidth]{../Images/inacctest/cornerr4m3mask.png}}
          &
        \addheight{\includegraphics[width=0.12\linewidth]{../Images/inacctest/cornerr4m4mask.png}}
          &
        \addheight{\includegraphics[width=0.12\linewidth]{../Images/inacctest/cornerr4m5mask.png}}
          &
        \addheight{\includegraphics[width=0.12\linewidth]{../Images/inacctest/cornerr4m6mask.png}}\\
        \raisebox{0.8cm}{5} &
        \addheight{\includegraphics[width=0.12\linewidth]{../Images/inacctest/cornerr5m1mask.png}}
          &
        \addheight{\includegraphics[width=0.12\linewidth]{../Images/inacctest/cornerr5m2mask.png}}
          &
        \addheight{\includegraphics[width=0.12\linewidth]{../Images/inacctest/cornerr5m3mask.png}}
          &
        \addheight{\includegraphics[width=0.12\linewidth]{../Images/inacctest/cornerr5m4mask.png}}
          &
        \addheight{\includegraphics[width=0.12\linewidth]{../Images/inacctest/cornerr5m5mask.png}}
          &
        \addheight{\includegraphics[width=0.12\linewidth]{../Images/inacctest/cornerr5m6mask.png}}\\\hline
    \end{tabular}
    \caption{Inpainting masks for image corner.pgm for varying integration scale and mask radius.}\label{fig:InaccTestMask}
\end{figure}
\begin{figure}[H]
    \centering
    \begin{tabular}{|c|cccccc|}
        ...
        \diagbox{$\rho$}{$R$}&1&2&3&4&5&6\\\hline
        \raisebox{0.8cm}{1} &
        \addheight{\includegraphics[width=0.12\linewidth]{../Images/inacctest/cornerr1m1inpaint.png}}
          &
        \addheight{\includegraphics[width=0.12\linewidth]{../Images/inacctest/cornerr1m2inpaint.png}}
          &
        \addheight{\includegraphics[width=0.12\linewidth]{../Images/inacctest/cornerr1m3inpaint.png}}
          &
        \addheight{\includegraphics[width=0.12\linewidth]{../Images/inacctest/cornerr1m4inpaint.png}}
          &
        \addheight{\includegraphics[width=0.12\linewidth]{../Images/inacctest/cornerr1m5inpaint.png}}
          &
        \addheight{\includegraphics[width=0.12\linewidth]{../Images/inacctest/cornerr1m6inpaint.png}}\\
        \raisebox{0.8cm}{2} &
        \addheight{\includegraphics[width=0.12\linewidth]{../Images/inacctest/cornerr2m1inpaint.png}}
          &
        \addheight{\includegraphics[width=0.12\linewidth]{../Images/inacctest/cornerr2m2inpaint.png}}
          &
        \addheight{\includegraphics[width=0.12\linewidth]{../Images/inacctest/cornerr2m3inpaint.png}}
          &
        \addheight{\includegraphics[width=0.12\linewidth]{../Images/inacctest/cornerr2m4inpaint.png}}
          &
        \addheight{\includegraphics[width=0.12\linewidth]{../Images/inacctest/cornerr2m5inpaint.png}}
          &
        \addheight{\includegraphics[width=0.12\linewidth]{../Images/inacctest/cornerr2m6inpaint.png}}\\
        \raisebox{0.8cm}{3} &
        \addheight{\includegraphics[width=0.12\linewidth]{../Images/inacctest/cornerr3m1inpaint.png}}
          &
        \addheight{\includegraphics[width=0.12\linewidth]{../Images/inacctest/cornerr3m2inpaint.png}}
          &
        \addheight{\includegraphics[width=0.12\linewidth]{../Images/inacctest/cornerr3m3inpaint.png}}
          &
        \addheight{\includegraphics[width=0.12\linewidth]{../Images/inacctest/cornerr3m4inpaint.png}}
          &
        \addheight{\includegraphics[width=0.12\linewidth]{../Images/inacctest/cornerr3m5inpaint.png}}
          &
        \addheight{\includegraphics[width=0.12\linewidth]{../Images/inacctest/cornerr3m6inpaint.png}}\\
        \raisebox{0.8cm}{4} &
        \addheight{\includegraphics[width=0.12\linewidth]{../Images/inacctest/cornerr4m1inpaint.png}}
          &
        \addheight{\includegraphics[width=0.12\linewidth]{../Images/inacctest/cornerr4m2inpaint.png}}
          &
        \addheight{\includegraphics[width=0.12\linewidth]{../Images/inacctest/cornerr4m3inpaint.png}}
          &
        \addheight{\includegraphics[width=0.12\linewidth]{../Images/inacctest/cornerr4m4inpaint.png}}
          &
        \addheight{\includegraphics[width=0.12\linewidth]{../Images/inacctest/cornerr4m5inpaint.png}}
          &
        \addheight{\includegraphics[width=0.12\linewidth]{../Images/inacctest/cornerr4m6inpaint.png}}\\
        \raisebox{0.8cm}{5} &
        \addheight{\includegraphics[width=0.12\linewidth]{../Images/inacctest/cornerr5m1inpaint.png}}
          &
        \addheight{\includegraphics[width=0.12\linewidth]{../Images/inacctest/cornerr5m2inpaint.png}}
          &
        \addheight{\includegraphics[width=0.12\linewidth]{../Images/inacctest/cornerr5m3inpaint.png}}
          &
        \addheight{\includegraphics[width=0.12\linewidth]{../Images/inacctest/cornerr5m4inpaint.png}}
          &
        \addheight{\includegraphics[width=0.12\linewidth]{../Images/inacctest/cornerr5m5inpaint.png}}
          &
        \addheight{\includegraphics[width=0.12\linewidth]{../Images/inacctest/cornerr5m6inpaint.png}}\\\hline
    \end{tabular}
...
Figure~\ref{fig:BinaryImages})}\label{fig:InaccTestInpaint}
\end{figure}
\begin{figure}[H]
    \centering
...
\begin{figure}[H]
    ...
    \begin{tabular}{|c|cccccc|}
        ...
        \diagbox{$\rho$}{$R$}&1&2&3&4&5&6\\\hline
        \raisebox{0.8cm}{1} &
        \addheight{\includegraphics[width=0.12\linewidth]{../Images/rect_inacc/rect_tinyr1m1mask.png}}
          &
        \addheight{\includegraphics[width=0.12\linewidth]{../Images/rect_inacc/rect_tinyr1m2mask.png}}
          &
        \addheight{\includegraphics[width=0.12\linewidth]{../Images/rect_inacc/rect_tinyr1m3mask.png}}
          &
        \addheight{\includegraphics[width=0.12\linewidth]{../Images/rect_inacc/rect_tinyr1m4mask.png}}
          &
        \addheight{\includegraphics[width=0.12\linewidth]{../Images/rect_inacc/rect_tinyr1m5mask.png}}
          &
        \addheight{\includegraphics[width=0.12\linewidth]{../Images/rect_inacc/rect_tinyr1m6mask.png}}\\
        \raisebox{0.8cm}{2} &
        \addheight{\includegraphics[width=0.12\linewidth]{../Images/rect_inacc/rect_tinyr2m1mask.png}}
          &
        \addheight{\includegraphics[width=0.12\linewidth]{../Images/rect_inacc/rect_tinyr2m2mask.png}}
          &
        \addheight{\includegraphics[width=0.12\linewidth]{../Images/rect_inacc/rect_tinyr2m3mask.png}}
          &
        \addheight{\includegraphics[width=0.12\linewidth]{../Images/rect_inacc/rect_tinyr2m4mask.png}}
          &
        \addheight{\includegraphics[width=0.12\linewidth]{../Images/rect_inacc/rect_tinyr2m5mask.png}}
          &
        \addheight{\includegraphics[width=0.12\linewidth]{../Images/rect_inacc/rect_tinyr2m6mask.png}}\\
        \raisebox{0.8cm}{3} &
        \addheight{\includegraphics[width=0.12\linewidth]{../Images/rect_inacc/rect_tinyr3m1mask.png}}
          &
        \addheight{\includegraphics[width=0.12\linewidth]{../Images/rect_inacc/rect_tinyr3m2mask.png}}
          &
        \addheight{\includegraphics[width=0.12\linewidth]{../Images/rect_inacc/rect_tinyr3m3mask.png}}
          &
        \addheight{\includegraphics[width=0.12\linewidth]{../Images/rect_inacc/rect_tinyr3m4mask.png}}
          &
        \addheight{\includegraphics[width=0.12\linewidth]{../Images/rect_inacc/rect_tinyr3m5mask.png}}
          &
        \addheight{\includegraphics[width=0.12\linewidth]{../Images/rect_inacc/rect_tinyr3m6mask.png}}\\
        \raisebox{0.8cm}{4} &
        \addheight{\includegraphics[width=0.12\linewidth]{../Images/rect_inacc/rect_tinyr4m1mask.png}}
          &
        \addheight{\includegraphics[width=0.12\linewidth]{../Images/rect_inacc/rect_tinyr4m2mask.png}}
          &
        \addheight{\includegraphics[width=0.12\linewidth]{../Images/rect_inacc/rect_tinyr4m3mask.png}}
          &
        \addheight{\includegraphics[width=0.12\linewidth]{../Images/rect_inacc/rect_tinyr4m4mask.png}}
          &
        \addheight{\includegraphics[width=0.12\linewidth]{../Images/rect_inacc/rect_tinyr4m5mask.png}}
          &
        \addheight{\includegraphics[width=0.12\linewidth]{../Images/rect_inacc/rect_tinyr4m6mask.png}}\\
        \raisebox{0.8cm}{5} &
        \addheight{\includegraphics[width=0.12\linewidth]{../Images/rect_inacc/rect_tinyr5m1mask.png}}
          &
        \addheight{\includegraphics[width=0.12\linewidth]{../Images/rect_inacc/rect_tinyr5m2mask.png}}
          &
        \addheight{\includegraphics[width=0.12\linewidth]{../Images/rect_inacc/rect_tinyr5m3mask.png}}
          &
        \addheight{\includegraphics[width=0.12\linewidth]{../Images/rect_inacc/rect_tinyr5m4mask.png}}
          &
        \addheight{\includegraphics[width=0.12\linewidth]{../Images/rect_inacc/rect_tinyr5m5mask.png}}
          &
        \addheight{\includegraphics[width=0.12\linewidth]{../Images/rect_inacc/rect_tinyr5m6mask.png}}\\\hline
    \end{tabular}
    \caption{Inpainting masks for image rect\_tiny.pgm for varying integration scale and mask radius.}\label{fig:RectInaccTestMask}
\end{figure}
\begin{figure}[H]
    \centering
    \begin{tabular}{|c|cccccc|}
        ...
        \diagbox{$\rho$}{$R$}&1&2&3&4&5&6\\\hline
        \raisebox{0.8cm}{1} &
        \addheight{\includegraphics[width=0.12\linewidth]{../Images/rect_inacc/rect_tinyr1m1inpaint.png}}
          &
        \addheight{\includegraphics[width=0.12\linewidth]{../Images/rect_inacc/rect_tinyr1m2inpaint.png}}
          &
        \addheight{\includegraphics[width=0.12\linewidth]{../Images/rect_inacc/rect_tinyr1m3inpaint.png}}
          &
        \addheight{\includegraphics[width=0.12\linewidth]{../Images/rect_inacc/rect_tinyr1m4inpaint.png}}
          &
        \addheight{\includegraphics[width=0.12\linewidth]{../Images/rect_inacc/rect_tinyr1m5inpaint.png}}
          &
        \addheight{\includegraphics[width=0.12\linewidth]{../Images/rect_inacc/rect_tinyr1m6inpaint.png}}\\
        \raisebox{0.8cm}{2} &
        \addheight{\includegraphics[width=0.12\linewidth]{../Images/rect_inacc/rect_tinyr2m1inpaint.png}}
          &
        \addheight{\includegraphics[width=0.12\linewidth]{../Images/rect_inacc/rect_tinyr2m2inpaint.png}}
          &
        \addheight{\includegraphics[width=0.12\linewidth]{../Images/rect_inacc/rect_tinyr2m3inpaint.png}}
          &
        \addheight{\includegraphics[width=0.12\linewidth]{../Images/rect_inacc/rect_tinyr2m4inpaint.png}}
          &
        \addheight{\includegraphics[width=0.12\linewidth]{../Images/rect_inacc/rect_tinyr2m5inpaint.png}}
          &
        \addheight{\includegraphics[width=0.12\linewidth]{../Images/rect_inacc/rect_tinyr2m6inpaint.png}}\\
        \raisebox{0.8cm}{3} &
        \addheight{\includegraphics[width=0.12\linewidth]{../Images/rect_inacc/rect_tinyr3m1inpaint.png}}
          &
        \addheight{\includegraphics[width=0.12\linewidth]{../Images/rect_inacc/rect_tinyr3m2inpaint.png}}
          &
        \addheight{\includegraphics[width=0.12\linewidth]{../Images/rect_inacc/rect_tinyr3m3inpaint.png}}
          &
        \addheight{\includegraphics[width=0.12\linewidth]{../Images/rect_inacc/rect_tinyr3m4inpaint.png}}
          &
        \addheight{\includegraphics[width=0.12\linewidth]{../Images/rect_inacc/rect_tinyr3m5inpaint.png}}
          &
        \addheight{\includegraphics[width=0.12\linewidth]{../Images/rect_inacc/rect_tinyr3m6inpaint.png}}\\
        \raisebox{0.8cm}{4} &
        \addheight{\includegraphics[width=0.12\linewidth]{../Images/rect_inacc/rect_tinyr4m1inpaint.png}}
          &
        \addheight{\includegraphics[width=0.12\linewidth]{../Images/rect_inacc/rect_tinyr4m2inpaint.png}}
          &
        \addheight{\includegraphics[width=0.12\linewidth]{../Images/rect_inacc/rect_tinyr4m3inpaint.png}}
          &
        \addheight{\includegraphics[width=0.12\linewidth]{../Images/rect_inacc/rect_tinyr4m4inpaint.png}}
          &
        \addheight{\includegraphics[width=0.12\linewidth]{../Images/rect_inacc/rect_tinyr4m5inpaint.png}}
          &
        \addheight{\includegraphics[width=0.12\linewidth]{../Images/rect_inacc/rect_tinyr4m6inpaint.png}}\\
        \raisebox{0.8cm}{5} &
        \addheight{\includegraphics[width=0.12\linewidth]{../Images/rect_inacc/rect_tinyr5m1inpaint.png}}
          &
        \addheight{\includegraphics[width=0.12\linewidth]{../Images/rect_inacc/rect_tinyr5m2inpaint.png}}
          &
        \addheight{\includegraphics[width=0.12\linewidth]{../Images/rect_inacc/rect_tinyr5m3inpaint.png}}
          &
        \addheight{\includegraphics[width=0.12\linewidth]{../Images/rect_inacc/rect_tinyr5m4inpaint.png}}
          &
        \addheight{\includegraphics[width=0.12\linewidth]{../Images/rect_inacc/rect_tinyr5m5inpaint.png}}
          &
        \addheight{\includegraphics[width=0.12\linewidth]{../Images/rect_inacc/rect_tinyr5m6inpaint.png}}\\\hline
    \end{tabular}
...
\texttt{ellipse\_small}}\label{fig:BinaryImages}
\end{figure}
\begin{figure}[h]
    \centering
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.4\linewidth]{../Images/cat/cat-mask1510.png}\hspace{0.2cm}
    \includegraphics[width=0.4\linewidth]{../Images/cat/cat-inpaint1510.png}
