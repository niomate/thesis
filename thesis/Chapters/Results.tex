...
Figure~\ref{fig:BinaryImages})}
    \label{fig:InaccTestInpaint}
\end{figure}
\begin{figure}[H]
    \centering
...
\begin{figure}[H]
    ...
    \end{tabular}
    \caption{Inpainting masks for image rect\_tiny.pgm for varying integration scale and mask radius.}
    \label{fig:RectInaccTestMask}
\end{figure}
\begin{figure}[H]
    \centering
    \begin{tabular}{|c|cccccc|}
    ...
    parameters: $\sigma=2,\lambda=0.4,\alpha=0.49,\gamma=1$. Original image see
Figure~\ref{fig:BinaryImages}}
    \label{fig:RectInaccTestInpaint}
\end{figure}
\begin{figure}[H]
    \centering
    \begin{tabular}{|c|c|c|c|c|c|c|}
...
\texttt{ellipse\_small}}
    \label{fig:BinaryImages}
\end{figure}
\begin{figure}[h]
    \centering
