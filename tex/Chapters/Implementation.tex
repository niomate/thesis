...
\end{align}
Sometimes however, central differences are not applicable, hence we have to
use one of the other schemes. One example is the time discretisation in many diffusion methods as
